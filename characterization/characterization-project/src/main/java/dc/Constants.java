...
import dc.SwerveModuleConstants;
...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        public static final double driveKS = (0.638 / 12); // (0.667 / 12); //divide by 12 to convert from volts to percent output for CTRE
        public static final double driveKV = (1.69 / 12); //(2.44 / 12);
        public static final double driveKA = (0.27/12);//(0.0661 / 12); //(0.27 / 12);
